...
export default function StreetView({ location }: StreetViewProps) {
  ...
  if (hasStreetView === false) {
    return (
      <div className="w-full h-full rounded-xl overflow-hidden border border-slate-200 shadow-inner bg-slate-100 flex flex-col items-center justify-center text-slate-500 p-4 text-center">
